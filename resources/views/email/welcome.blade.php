...
@section('content')
    ...
    <p>
        We're thrilled to welcome you to wintogetherplan.com! Thank you for registering with us.
    </p>

    <p>
        At wintogetherplan.com, we're committed to providing you with the best possible experience.
