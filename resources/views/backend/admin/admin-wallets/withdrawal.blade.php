<x-backend.layouts.app>
    @section('title', 'Wallet Withdrawal | Reports')
    @section('header-title', 'Admin Wallet Withdrawal | Reports 11' )
    ...
    @section('breadcrumb-items')
        <li class="breadcrumb-item">Withdrawal History</li>
    @endsection
    ...
    @push('scripts')
        ...
        <script src="{{ asset('assets/backend/js/admin/admin-wallets/withdrawal.js') }}"></script>
    @endpush
</x-backend.layouts.app>
