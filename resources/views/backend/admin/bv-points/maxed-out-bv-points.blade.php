<x-backend.layouts.app>
                    ...
                    <div>
                        <div class="md:flex md:flex-wrap">
                            ...
                            <div class="flex flex-col mb-2 md:w-1/2 lg:w-1/4">
                                <div>
                                    <div class=" pt-2 p-2 ">
                                        <label for="maxed-out-date-range" class="text-gray-700 dark:text-gray-300">PERIOD</label>
                                        <div class="relative">
                                            <form autocomplete="off">
                                                <input id="maxed-out-date-range" class="flatpickr block my-1 bg-gray-50 text-gray-700 py-2 px-3 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500 w-full active dark:bg-gray-500 dark:text-gray-200 dark:placeholder-gray-200 dark:border-gray-500 flatpickr-input" type="text" placeholder="Select a period" readonly="readonly">
                                            </form>
                            ...
                            <div class="flex flex-col mb-2">
                                <div>
                                    <div class=" pt-2 p-2 ">
                                        ...
                                        <div class="relative">
                                            <button id="filter-button" class="mt-1 inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
                                                Search
                                            </button>
                                        </div>
                                    </div>
    ...
    @push('scripts')
        ...
        <script src="{{ asset('assets/backend/js/admin/bv-points/maxed-out-bv-points.js') }}"></script>
    @endpush
</x-backend.layouts.app>
