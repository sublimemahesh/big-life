<div class="col-12">
    <div class="order nav nav-tabs">
        ...
        @can('viewRequirement', \App\Models\RankBonusSummery::class)
            <a class=" d-none nav-link {{ request()->routeIs('user.ranks.benefits.requirements') ? 'active' : '' }}" href="{{ !request()->routeIs('user.ranks.benefits.requirements') ? route('user.ranks.benefits.requirements') : 'javascript:void(0)' }}">Bonus Requirement</a>
        @endcan
